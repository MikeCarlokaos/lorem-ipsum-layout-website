    ...
    <section className="relative z-20 w-full h-full flex flex-col pt-5 items-center ">
      <div className="py-5">
        <a
          ...
          className="group relative py-5 px-10 mt-10 overflow-hidden bg-stone-300 shadow rounded-e-xl"
        >
          <div className="absolute inset-0 w-1.5 bg-stone-600 transition-all duration-[250ms] ease-out group-hover:w-full rounded-e-xl"></div>
          <span className="relative text-black text-2xl font-semibold capitalize group-hover:text-white">
            about
          </span>
        </a>
      </div>
